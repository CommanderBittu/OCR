...
const MessageContent = ({ content }: { content: string }) => {
  return (
    <div className="markdown-content prose prose-invert max-w-none prose-p:my-1 prose-headings:mt-2 prose-headings:mb-1">
      <ReactMarkdown
        components={{
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [
        ...
        {
          role: 'bot',
          content: 'I apologize, but I couldn\'t process your request. This could be due to API connection issues or configuration problems. Please ensure your Gemini API key is valid and properly configured in your environment variables. If this problem persists, you might need to check which Gemini models are available for your API key.',
          timestamp: new Date().toISOString()
        }
      ]);
    } finally {
